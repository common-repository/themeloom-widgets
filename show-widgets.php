...
class los_showposts_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'los_showposts_widget', // Base ID
            __('Show Posts', 'livingos'), // Name
            array( 'description' => __('Show teasers/list of posts with thumbs, filtered by category.','livingos'), ) // Args
        );
    }
...
class los_showpages_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'los_show_pages', // Base ID
            __('Show Pages', 'livingos'), // Name
            array( 'description' =>  __('Show teasers/list of pages with thumbs.','livingos'), ) // Args
        );
    }
...
class los_media_widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            'los_media_widget', // Base ID
            __('Show Media Posts','livingos'), // Name
            array( 'description' =>  __('Show latest posts in category with audio attachments.','livingos'), ) // Args
        );
    }
